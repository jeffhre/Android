...
import event_recycler.EventRecyclerFragment;
...
public class EventListActivity extends AppCompatActivity {
    ...
    private static final String jl = "JEFF_EVENT_ACTIVITY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager.beginTransaction()
                .add(R.id.event_recycler_frame, erf)
                .commit();

        setTitle("Your Event List");
